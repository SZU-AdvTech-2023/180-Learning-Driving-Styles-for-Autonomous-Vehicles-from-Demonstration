...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', default='raw_train',type=str, help='path to dataset files')
    parser.add_argument('--load_path', default='/home/lin/waymo_dataset/',type=str, help='path to dataset files')
    parser.add_argument('--save_path',  default='/home/lin/waymo_dataset/',type=str,help='path to save processed data')
    parser.add_argument('--use_multiprocessing', default=True,  action="store_true", help='if use multiprocessing')
    
    args = parser.parse_args()
    data_files = glob.glob(args.load_path+args.name+'_20s/*')
