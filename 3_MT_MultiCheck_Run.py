...
def train_task():
    ...
    for task_epoch in range(1, args.task_epochs+1):
        ...
        for task_i, x_spt in enumerate(test_loader):
            ...
            paramModel.load_state_dict(torch.load(args.model_path+args.cost_type+f"/behavior_{behavior_i}.pth", map_location=device))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, help='path to saved model', default='/home/lin/waymo_dataset/model_param/epoch10_model_')
